...
Add-Superhero -Name "Evilin" -VillainAbilities "Necromancy","Energy Drain" -Abilities "Invulnerability" -Verbose
Add-Superhero -Name "Amazing Man" -HeroAbilities "Healing","Super Speed" -Abilities "Invulnerability","Flying" -Verbose
